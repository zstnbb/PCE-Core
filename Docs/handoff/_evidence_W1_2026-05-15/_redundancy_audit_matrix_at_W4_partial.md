...
| F6 P6 Claude Code CLI       | 1 | **3** ✅ W1-T3 (L3h) + W4-T6 (L1, 08:39 UTC) + L3g (pre-existing) | 3 | 3 | 3 | (达标) |
| F6 P7 Codex CLI             | 0 | **2** ✅ W1-T8 + W1-T9 (W4-T7 L1 blocked: Rust TLS bypass) | 3 | 3 | 3 | W4-T7 (Rust proxy fix, 1-2d eng) |
| F6 P8 Gemini CLI            | 0 | **2** ✅ W1-T10 + W1-T11 + bug fix 097a1d2 (W4-T8 L1 blocked: Node undici bypass) | 3 | 3 | 3 | W4-T8 (undici ProxyAgent fix, 1-2d eng) |
